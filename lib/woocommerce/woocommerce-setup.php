...
add_action( 'wp_enqueue_scripts', 'theme_products_match_height', 99 );
/**
 * Print an inline script to the footer to keep products the same height.
 *
 * @since 2.3.0
 */
function theme_products_match_height() {
...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'theme_woocommerce_breakpoint' );
/**
 ...
 */
function theme_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'theme_default_products_per_page' );
/**
 ...
 */
function theme_default_products_per_page() {
	return 8;
}

add_filter( 'woocommerce_pagination_args', 	'theme_woocommerce_pagination' );
/**
 ...
 */
function theme_woocommerce_pagination( $args ) {
...
add_action( 'after_switch_theme', 'theme_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
* Define WooCommerce image sizes on theme activation.
*
* @since 2.3.0
*/
function theme_woocommerce_image_dimensions_after_theme_setup() {
	...
	theme_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'theme_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 * Define the WooCommerce image sizes on WooCommerce activation.
 *
 * @since 2.3.0
 */
function theme_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function theme_update_woocommerce_image_dimensions() {
